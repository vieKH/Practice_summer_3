...
from PyQt6.QtWidgets import QPushButton, QFileDialog, QApplication, QMainWindow, QLabel
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        button_crt_upfile_ext = self.add_button("Upload extract image", 150, 50, 125, 175)
        ...
        button_crt_embed.clicked.connect(self.embed)
    ...
    def embed(self):
        try:
            pixmap = QtGui.QPixmap(self.path_original).scaled(self.image.height(),
                                                              self.image.width(),
